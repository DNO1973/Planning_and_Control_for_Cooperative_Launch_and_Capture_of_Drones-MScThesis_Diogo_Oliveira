...
class SendToWaitingPoint(smach.State):
    def __init__(self):
        ...
        self.reached_pos_sub = rospy.Subscriber("/cooperative_planning/state_machine/shuttle_reached_desired_position", Empty, self.posReachedCb, queue_size=1)
